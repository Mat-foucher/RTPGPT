...
def ask_rtp_question(question, your_chunks, doc_embedding,top_k=3, last_message = ""):
  ...
  try:
    ...
    Remember that new ticket types are organized under product headers. Additionally, if the question does not specify 
    which system the question is for, you will ask 'what system is this for?' to clarify, you are only to do this for the first question.
